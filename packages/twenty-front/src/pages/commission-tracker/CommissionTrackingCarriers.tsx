...
const StyledButtonContainer = styled.div`
  padding: 7px;
  background-color: #e4e4e4; /* Set the background color */
    ...
    return (
        <StyledEightyPercent>
          ...
          <StyledRecordItemDropdown>
            <RecordItemDropdown dropdownTitle="Carrier #1">
              Sup
            </RecordItemDropdown>
          </StyledRecordItemDropdown>
  
          <StyledRecordItemDropdown>
            <RecordItemDropdown dropdownTitle="Carrier #5">
              Sup
            </RecordItemDropdown>
          </StyledRecordItemDropdown>
  
          <StyledRecordItemDropdown>
            <RecordItemDropdown dropdownTitle="Carrier #4">
              Sup
            </RecordItemDropdown>
          </StyledRecordItemDropdown>
          </StyledFieldsContainer>
