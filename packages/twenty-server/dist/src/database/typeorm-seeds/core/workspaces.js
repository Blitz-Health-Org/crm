...
exports.deleteWorkspaces = exports.seedWorkspaces = exports.SeedWorkspaceId = void 0;
const tableName = 'workspace';
exports.SeedWorkspaceId = '20202020-1c25-4d02-bf25-6aeccf7ea419';
const seedWorkspaces = async (workspaceDataSource, schemaName, workspaceId) => {
...
exports.seedWorkspaces = seedWorkspaces;
const deleteWorkspaces = async (workspaceDataSource, schemaName, workspaceId) => {
    await workspaceDataSource
        .createQueryBuilder()
        .delete()
...
exports.deleteWorkspaces = deleteWorkspaces;
