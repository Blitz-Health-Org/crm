...
export declare enum MemoryStorageDriverType {
    Local = "local"
}
...
export type MemoryStorageModuleOptions = MemoryStorageModuleBaseOptions & LocalMemoryDriverFactoryOptions;
export type MemoryStorageModuleAsyncOptions = {
    identifier: string;
    useFactory: (...args: any[]) => Omit<MemoryStorageModuleOptions, 'identifier'> | Promise<Omit<MemoryStorageModuleOptions, 'identifier'>>;
