...
export declare enum MessageQueueDriverType {
    PgBoss = "pg-boss",
    BullMQ = "bull-mq",
    Sync = "sync"
}
...
export type MessageQueueModuleOptions = PgBossDriverFactoryOptions | BullMQDriverFactoryOptions | SyncDriverFactoryOptions;
export type MessageQueueModuleAsyncOptions = {
    useFactory: (...args: any[]) => MessageQueueModuleOptions | Promise<MessageQueueModuleOptions>;
