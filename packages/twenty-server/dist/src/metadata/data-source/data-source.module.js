...
const data_source_entity_1 = require("./data-source.entity");
...
exports.DataSourceModule = DataSourceModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([data_source_entity_1.DataSourceEntity], 'metadata')],
        providers: [data_source_service_1.DataSourceService],
        exports: [data_source_service_1.DataSourceService],
    })
], DataSourceModule);
