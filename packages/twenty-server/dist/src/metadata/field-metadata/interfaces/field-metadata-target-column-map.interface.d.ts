...
type TypeByFieldMetadata<T extends FieldMetadataType | 'default'> = [
    T
] extends [keyof FieldMetadataTypeMapping] ? FieldMetadataTypeMapping[T] : T extends 'default' ? AllFieldMetadataTypes : FieldMetadataTargetColumnMapValue;
export type FieldMetadataTargetColumnMap<T extends FieldMetadataType | 'default' = 'default'> = TypeByFieldMetadata<T>;
export {};
