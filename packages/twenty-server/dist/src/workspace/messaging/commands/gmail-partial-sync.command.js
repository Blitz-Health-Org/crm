...
exports.GmailPartialSyncCommand = void 0;
...
let GmailPartialSyncCommand = class GmailPartialSyncCommand extends nest_commander_1.CommandRunner {
    ...
    async fetchWorkspaceMessages(workspaceId) {
        ...
        for (const connectedAccount of connectedAccounts) {
            await this.messagingProducer.enqueueGmailPartialSync({ workspaceId, connectedAccountId: connectedAccount.id }, `${workspaceId}-${connectedAccount.id}`);
        }
    }
};
exports.GmailPartialSyncCommand = GmailPartialSyncCommand;
__decorate([
...
], GmailPartialSyncCommand.prototype, "parseWorkspaceId", null);
exports.GmailPartialSyncCommand = GmailPartialSyncCommand = __decorate([
...
//# sourceMappingURL=gmail-partial-sync.command.js.map