...
let FindOneQueryFactory = FindOneQueryFactory_1 = class FindOneQueryFactory {
    constructor(fieldsStringFactory, argsStringFactory) {
        ...
        this.logger = new common_1.Logger(FindOneQueryFactory_1.name);
    }
...
exports.FindOneQueryFactory = FindOneQueryFactory = FindOneQueryFactory_1 = __decorate([
