...
export declare class UpdateOneQueryFactory {
    ...
    create<Record extends IRecord = IRecord>(args: UpdateOneResolverArgs<Record>, options: WorkspaceQueryBuilderOptions): Promise<string>;
}
