...
var UpdateOneQueryFactory_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.UpdateOneQueryFactory = void 0;
...
let UpdateOneQueryFactory = UpdateOneQueryFactory_1 = class UpdateOneQueryFactory {
    constructor(fieldsStringFactory, argsAliasFactory) {
        ...
        this.logger = new common_1.Logger(UpdateOneQueryFactory_1.name);
    }
    async create(args, options) {
        ...
        return `
      mutation {
        update${(0, compute_object_target_table_util_1.computeObjectTargetTable)(options.objectMetadataItem)}Collection(set: ${(0, stringify_without_key_quote_util_1.stringifyWithoutKeyQuote)(argsData)}, filter: { id: { eq: "${computedArgs.id}" } }) {
          affectedCount
          records {
            ${fieldsString}
          }
...
exports.UpdateOneQueryFactory = UpdateOneQueryFactory;
exports.UpdateOneQueryFactory = UpdateOneQueryFactory = UpdateOneQueryFactory_1 = __decorate([
...
//# sourceMappingURL=update-one-query.factory.js.map