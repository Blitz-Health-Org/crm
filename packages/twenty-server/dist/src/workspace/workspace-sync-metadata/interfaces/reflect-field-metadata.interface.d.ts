...
export interface FieldMetadataDecoratorParams<T extends FieldMetadataType | 'default'> {
    type: T;
    label: string;
    description?: string;
    icon?: string;
...
export interface ReflectFieldMetadata {
    [key: string]: Omit<FieldMetadataDecoratorParams<'default'>, 'defaultValue' | 'type' | 'options'> & {
        name: string;
